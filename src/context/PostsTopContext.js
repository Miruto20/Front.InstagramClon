...
export const PostsTopContext = createContext();

export const CustomPostsTopContextProvider = ({ children }) => {
    ...
    const fetchPosts = async () => {
      try {
        ...
        const res = await fetch(
          `http://localhost:4000/posts/top?${searchParams.toString()}`,
          {
...
export const usePostsTopContext = () => {
  return useContext(PostsTopContext);
};
